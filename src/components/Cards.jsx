...
const Cards = ({item,index,deleteTask,isComplete,editTask}) => {
  return (
    <div className='flex justify-between items-center p-1 xl:p-2 2xl:p-4 text-sm xl:text-lg 2xl:text-xl shadow-md shadow-black/60 font-semibold text-white rounded-md bg-linear-to-r from-blue-500 to-purple-500'>
      <div className='flex justify-center items-center p-2'>
        <input type="checkbox" checked={item.status} onChange={()=>{isComplete(item.id)}} className='mr-2 size-5 accent-emerald-500' />
